    ...
    return (
        <Container>
           ...
           <Typography component="div" variant="h4" sx={{color:"#4d9296", mt:2}}>
            ...
            <TextField sx={{backgroundColor:"#FFFFFF"}} name="descripcion" label="Descripción del laboratorio:" variant="outlined" required></TextField>
            </FormControl>

            <FormControl fullWidth sx={{m:1, mt:2}}>
            <TextField sx={{backgroundColor:"#FFFFFF"}} name="ubicacion" label="Ubicación del laboratorio:" variant="outlined" required></TextField>
            </FormControl>
            ...
            <FormControl fullWidth sx={{m:1}}>
            <TextField sx={{backgroundColor:"#FFFFFF"}} type="number" name="precio_consulta" label="Precio por Exámen:" variant="outlined" required></TextField>
            </FormControl>
